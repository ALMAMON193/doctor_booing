...
class AppointmentController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Query the AppointmentBooking for appointments with the authenticated psychologist
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    ...
                    <div class="btn-group btn-group-sm btn-group-custom" role="group" aria-label="Basic example">
                        <a href="' . route('doctor.appointment.details', $data->id) . '" class="btn btn-outline-primary" title="View">
    ...
    public function destroy($id)
    {
        try {
            // dd($id);
            $data = AppointmentBooking::findOrFail($id);
            $data->delete();
    ...
    public function details($id){
        $appointment = AppointmentBooking::with('psychologist')->find($id);
        return view('backend.doctor.layouts.appointment_details', compact('appointment'));
    }
}
