    ...
    <div class="main-content">
        <div class="main-content-container">
                ...
                <div class="d-flex">
                    <div id="date-container" class="date-container">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none">
                            <path d="M8 2V5" stroke="#252C32" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M16 2V5" stroke="#252C32" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M3.5 9.08997H20.5" stroke="#252C32" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path
            ...
            <div class="data-table-container mt-4">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2 ">
                                        <img style="width: 32px; height: 32px; object-fit: cover;"
                                            src="{{ asset('backend/doctor/images/user.png') }}" alt="">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3 ">
                                        <svg data-bs-toggle="modal" data-bs-target="#exampleModal"
                                            style="cursor: pointer;" xmlns="http://www.w3.org/2000/svg" width="20"
                                            height="20" viewBox="0 0 20 20" fill="none">
                                            <path
                                                d="M19.8728 9.61095C19.6942 9.36654 15.437 3.62634 9.99988 3.62634C4.56273 3.62634 0.305387 9.36654 0.12691 9.61072C0.0444411 9.7237 0 9.85996 0 9.99984C0 10.1397 0.0444411 10.276 0.12691 10.389C0.305387 10.6334 4.56273 16.3736 9.99988 16.3736C15.437 16.3736 19.6942 10.6333 19.8728 10.3892C19.9554 10.2762 19.9999 10.14 19.9999 10.0001C19.9999 9.86015 19.9554 9.72388 19.8728 9.61095ZM9.99988 15.0549C5.99484 15.0549 2.52605 11.245 1.49921 9.99951C2.52472 8.75291 5.98625 4.94501 9.99988 4.94501C14.0047 4.94501 17.4733 8.75423 18.5005 10.0004C17.475 11.247 14.0135 15.0549 9.99988 15.0549Z"
                                                fill="#1E1E1E" />
                                            <path
                                                d="M9.99976 6.04395C7.81843 6.04395 6.0437 7.81867 6.0437 10C6.0437 12.1813 7.81843 13.9561 9.99976 13.9561C12.1811 13.9561 13.9558 12.1813 13.9558 10C13.9558 7.81867 12.1811 6.04395 9.99976 6.04395ZM9.99976 12.6373C8.54546 12.6373 7.36241 11.4543 7.36241 10C7.36241 8.54574 8.5455 7.36266 9.99976 7.36266C11.454 7.36266 12.6371 8.54574 12.6371 10C12.6371 11.4543 11.4541 12.6373 9.99976 12.6373Z"
                                                fill="#1E1E1E" />
                                        </svg>
                ...
                <div
                    class="pagination-container px-0 px-lg-5 mt-4 d-flex align-items-center justify-content-between gap-4">
                    <div style="cursor: pointer;" class="d-flex align-items-center gap-1 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path d="M7.97533 4.94167L2.91699 10L7.97533 15.0583" stroke="#4F4F4F" stroke-width="1.5"
                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M17.0836 10H3.05859" stroke="#4F4F4F" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        <span>Previous</span>
                    </div>
                    ...
                    <div style="cursor: pointer;" class="d-flex align-items-center gap-1 ">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path d="M12.0249 4.94167L17.0832 10L12.0249 15.0583" stroke="#4F4F4F" stroke-width="1.5"
                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M2.9165 10H16.9415" stroke="#4F4F4F" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                </div>
