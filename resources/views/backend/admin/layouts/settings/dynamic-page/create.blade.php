@extends('backend.admin.app', ['title' => 'Dynamic Page Create'])
    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Dynamic Page Create</h1>
                </div>
                        ...
                        <div class="tab-pane active show" id="editProfile">
                            <div class="card">
                                <div class="card-body border-0">
                                    <form class="form-horizontal" method="post" action="{{ route('admin.setting.dynamic.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row mb-4">
