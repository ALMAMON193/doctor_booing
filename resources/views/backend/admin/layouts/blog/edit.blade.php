@extends('backend.admin.app', ['title' => 'Blog Edit'])
                                ...
                                <div class="card">
                                    <div class="card-body border-0">
                                        <form class="form-horizontal" method="post"
                                            action="{{ route('admin.blog.update', $data->id ?? '') }}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="description form-control @error('description') is-invalid @enderror" name="description"
                                                        placeholder="description" id="description">{{ old('description') ?? $data->description ?? '' }}</textarea>
                                                    @error('description')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
