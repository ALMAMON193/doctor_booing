@extends('backend.admin.app', ['title' => 'Service Benefits Therapy Create'])
    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Benefits Therapy Create</h1>
                </div>
                        ...
                        <div class="tab-pane active show" id="editProfile">
                            <div class="card">
                                <div class="card-body border-0">
                                    <form class="form-horizontal" method="post" action="{{ route('admin.cms.service.benefitsTherapy.store') }}">
                                        @csrf
                                        <div class="row mb-4">
