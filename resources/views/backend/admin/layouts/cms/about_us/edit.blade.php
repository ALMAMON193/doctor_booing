@extends('backend.admin.app', ['title' => 'Edit About Us'])
                                ...
                                <div class="card">
                                    <div class="card-body border-0">
                                        <form class="form-horizontal" method="post"
                                            action="{{ route('admin.aboutUs.update', $data->id ?? '' ) }}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="description form-control @error('content') is-invalid @enderror" name="content"
                                                        id="content">{{ old('content') ?? $data->content ?? '' }}</textarea>
                                                    @error('content')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
