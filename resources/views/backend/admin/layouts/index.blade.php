                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p class="text-muted fs-13 mb-0">All Users</p>
                                </div>
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{$totalDoctor ?? ""}}</h3>
                                    <p class="text-muted fs-13 mb-0">Total Psychologist</p>
                                </div>
                                <div class="col col-auto top-icn dash">
                                    <div
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{$totalBlog ?? ""}}</h3>
                                    <p class="text-muted fs-13 mb-0">Total Blog</p>
                                </div>
                                <div class="col col-auto top-icn dash">
