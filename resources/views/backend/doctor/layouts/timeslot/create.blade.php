...
@section('title', 'TimeSlot created')
...
@section('content')
    <div class="main-content">
        ...
        <div class="main-content-container">
            ...
            <form class="tm-form mt-5" action="{{ route('doctor.timeslot.store') }}" method="POST">
               @csrf
                ...
                <button style="background-color: #187586;" class="tm-dashboard-btn" type="submit">Submit</button>
            </form>
