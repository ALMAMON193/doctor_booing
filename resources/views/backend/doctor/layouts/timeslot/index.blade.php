...
@section('content')
    <div class="main-content">
        <div class="main-content-container">
            ...
            <div class="section-title mt-4 d-flex justify-content-between align-items-center">Time slot
                <a href="{{ route('doctor.timeslot.create') }}" class="btn btn-success"
                   style="background-color:#187586
                   ">Create</a>
            </div>
    ...
    <script>
        $(function () {
            var table = $('#datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('doctor.timeslot.index') }}",
                columns: [
                    {data: 'id', name: 'id'},
        ...
        function statusChange(id) {
            let url = "{{ route('doctor.timeslot.status', ':id') }}";
        ...
        function deleteItem(id) {
            let url = "{{ route('doctor.timeslot.destroy', ':id') }}";
